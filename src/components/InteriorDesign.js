...
function InteriorDesign () {
    ...
    (function() {
        setTimeout(function() {
          document.querySelector('#servis-change-style1').style.backgroundColor = "#CAA892";
          document.querySelector('#servis-change-style1').style.borderColor = "#CAA892"; 
        ...
        setTimeout(function() {
          ...
          setTimeout(function() {
            document.querySelector('#servis-change-style2').style.backgroundColor = "#CAA892";
            document.querySelector('#servis-change-style2').style.borderColor = "#CAA892"; 
          ...
          setTimeout(function() {
            ...
            setTimeout(function() {
                document.querySelector('#servis-change-style3').style.backgroundColor = "#CAA892";
                document.querySelector('#servis-change-style3').style.borderColor = "#CAA892"; 
              ...
              setTimeout(function() {
                ...
                setTimeout(function() {
                    document.querySelector('#servis-change-style4').style.backgroundColor = "#CAA892";
                    document.querySelector('#servis-change-style4').style.borderColor = "#CAA892"; 
                  ...
                  setTimeout(function() {
                    ...
                    setTimeout(function() {
                        document.querySelector('#servis-change-style5').style.backgroundColor = "#CAA892";
                        document.querySelector('#servis-change-style5').style.borderColor = "#CAA892"; 
                        ...
                        document.querySelector('#servis-change-style5-img').style.filter = "invert(1)"; 
                      }, 12000);
    ...
    return(
        ...
        <div className="our-servis-icon">
          ...
          <a  id="servis-change-style5" className="our-servis-card" href="">
            <div className="our-servis-interior1">
              <img id="servis-change-style5-img" src="images/sr.png" alt="our-servis-interior" />
              <div className="our-servis-card-text">
